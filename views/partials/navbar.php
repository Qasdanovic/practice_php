          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/" class="<?php get_bg("/") ?> rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Dashboard</a>
                  ...
                  <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    <?php if(isset($_SESSION["user"])) : ?>
                      <img class="size-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                        ...
                        <button type="submit" class="bg-red-600 text-gray-100 rounded py-2 px-4">
                            log out
                        </button>
                        </form>
                    <?php else : ?>
                        <a href="/register" class="<?php get_bg("/register") ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">register</a>
                        <a href="/login" class="<?php get_bg("/login") ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Log in</a>
                    <?php endif ; ?>
                  </button>
                </div>
